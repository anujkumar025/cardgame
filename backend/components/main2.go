...
type Manager interface {
	...
	GetAll() ([]Data, error) // Add GetAll() method to retrieve all data
	UpdateData(Data) error
	InsertOrUpdate(Data) error
}

func connectDb() {
	uri := "mongodb+srv://ffriction73:X06nqN1wm85S90FH@cluster0.vfqcllj.mongodb.net/?retryWrites=true&w=majority"
...
func main() {
	...
	app.Post("/updatescore", func(c *fiber.Ctx) error {
		...
		fmt.Println("Received data", newdata)
	...
	app.Get("/getall", func(c *fiber.Ctx) error {
		...
		fmt.Println("getall data", bigdata)
